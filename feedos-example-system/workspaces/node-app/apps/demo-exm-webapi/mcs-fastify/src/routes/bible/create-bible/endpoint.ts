...
} from '@feedos-example-system/exm-api-service/command/create-bible';
...
import { CreateBibleRepo } from '@feedos-example-system/exm-data-store-prisma/bible-factory/command/create-bible';
