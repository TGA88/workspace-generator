...
} from '@gu-example-system/exm-api-service/command/cancel-bible';
...
import {
  ...
  OutputModel,
  Repository,
} from '@gu-example-system/exm-api-core/command/cancel-bible';
import { PrismaClient, getPrismaInstance } from '@gu-example-system/exm-data-store-prisma';
import {CancelBibleRepo } from '@gu-example-system/exm-data-store-prisma/bible-factory/command/cancel-bible';
// import {CancelBibleRepo} from '@gu-example-system/exm-data-store-prisma/bible-factory/command/cancel-bible';
