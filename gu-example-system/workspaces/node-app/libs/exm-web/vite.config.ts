...
const preserveUseClientDirective = (): Plugin => {
  return {
    ...
    renderChunk(code: string, chunk: RenderedChunk, _options: NormalizedOutputOptions) {
      // เพิ่ม this context
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      '@exm-web': resolve(__dirname, './lib'),
      '@feature-demo1': resolve(__dirname, './lib/feature-demo1'),
      '@ui-exm-web': resolve(__dirname, './lib/ui-exm-web'),
    },
  },
  build: {
