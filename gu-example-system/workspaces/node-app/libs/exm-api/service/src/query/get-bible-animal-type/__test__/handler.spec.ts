...
import { Repository,GetAnimalTypeOutput, Failures } from '@gu-example-system/exm-api-core/query/get-bible-animal-type';

const mockRepository: Repository = jest.createMockFromModule(
  '@gu-example-system/exm-api-core/query/get-bible-animal-type',
);
