...
import { Repository, OutputModel, Failures } from '@gu-example-system/exm-api-core/query/get-bible-medicine';

const mockRepository: Repository = jest.createMockFromModule(
  '@gu-example-system/exm-api-core/query/get-bible-medicine',
);
